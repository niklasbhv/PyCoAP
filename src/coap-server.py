# Implementation eines CoAP Servers
# Horcht nach dem Starten auf Port 5683 auf eingehende Verbindungen
...
class postCheck(resource.Resource):
    def __init__(self):
        super().__init__()
    ...
    async def render_post(self, request):
        ...
        if request.mtype == 0:
            ...
            return aiocoap.Message(code=aiocoap.NoResponse)
...
async def main():
    ...
    root.add_resource(["postcheck"], postCheck())
